# plugin manager for ZBRUSH 2020

# the plugins and especially the third parties plugins had to be added
# (switch, routinedef, uistate, reloadplugin etc..)
...
official =  [   'Layer Brush Depth', 'Quick Scaler', 'ZBrush Compositor', 'Kitco Metal Quotes',
                ...
                'PanelLoop Presets', 'Clean Tool Master', 'ZRepeatIt', 'IMM Extractor',
